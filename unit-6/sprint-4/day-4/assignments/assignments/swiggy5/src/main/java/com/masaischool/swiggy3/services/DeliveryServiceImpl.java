...
public class DeliveryServiceImpl implements DeliveryService{
    ...
    @Override
    public Customer getCustomerDetailsByEmail(String email) throws SwiggyException {
        return crepo.findByEmail(email).orElseThrow(()->new SwiggyException("customer is not available with this email "+email));
    }

    @Override
    public Restaurant getRestaurant(String name) throws SwiggyException {
        return rRepo.findByName(name).orElseThrow(()->new SwiggyException("Restaurant is not available with this name "+name));
    }
}
